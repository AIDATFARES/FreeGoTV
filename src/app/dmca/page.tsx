    ...
    <main className="flex-grow px-5 pb-20 pt-12 sm:px-8 md:pt-16">
      <article className="mx-auto max-w-4xl">
        <header className="border-b border-black/10 pb-10 text-center mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-stone-600">Last updated: {currentDate}</p>
        </header>
        ...
        <div className="mt-10 space-y-10 text-base leading-7 text-on-surface-variant">
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-5 text-sm">
              <strong className="text-black">Important:</strong> FreeGoTV delivers an intuitive IPTV service interface alongside account provisioning. We do not host, upload, store, or archive any audiovisual content. The details on this site are provided 'as is' for general guidance, not legal counsel.
            </div>
          </div>

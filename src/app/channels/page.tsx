            ...
            <AnimatePresence>
              {filteredChannels.map((channel) => (
                <motion.div
                  ...
                  className="bg-white border-2 border-stone-100 hover:border-[#FF6B00] rounded-2xl p-4 flex items-center gap-3.5 transition-all hover:shadow-md hover:shadow-[#FF6B00]/10 group"
                >

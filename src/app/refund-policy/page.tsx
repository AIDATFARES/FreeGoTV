...
export const metadata: Metadata = {
  ...
  description: "Read the official FreeGoTV refund policy. Learn about our 7-day money-back guarantee, refund eligibility, and how to request a secure refund for your IPTV subscription.",
  alternates: {
...
const sections = [
  ...
  },
  {
    ...
    items: [
      <>Connect with our support team using our <Link className="font-semibold text-[#0EA5E9] hover:text-sky-400" href="/contact">Contact page</Link>.</>,
  ...
  },
  {
    ...
    content: [
      <>Contact: Send a message via our <Link className="font-semibold text-[#0EA5E9] hover:text-sky-400" href="/contact">Contact page</Link></>,
  ...
  },
  {
    ...
    items: [
      <>You are discontent with the <Link className="font-semibold text-[#0EA5E9] hover:text-sky-400" href="/channels">channel list</Link> or provided content.</>,
  ...
  },
  {
    ...
    items: [
      ...
      <>Use Setup Guides: Follow our step by step <Link className="font-semibold text-[#0EA5E9] hover:text-sky-400" href="/installation">Installation page</Link>.</>,
      <>Ask Support First: Most issues are solved in minutes—please <Link className="font-semibold text-[#0EA5E9] hover:text-sky-400" href="/contact">contact support</Link>.</>,
    ],
  },
];
      ...
      <article className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 space-y-10 text-base leading-7 text-on-surface-variant">
          ...
          <section>
            ...
            <p className="mt-4">If you have any questions regarding our Refund Policy, please contact our <Link className="font-semibold text-[#0EA5E9] hover:text-sky-400" href="/contact">support team</Link>.</p>
          </section>
        </div>
      </article>
    </main>

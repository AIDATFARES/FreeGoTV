  ...
  return (
    <main className="mx-auto w-full max-w-[1440px] flex-grow px-5 pb-20 pt-12 sm:px-8 md:px-12 text-format-technical">
      ...
      <section className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-stone-600">Our support team is available 24/7 to assist you with installation.</p>
...
function QuickStartCard({ children, icon: Icon, step, title }: { children: React.ReactNode; icon: typeof Download; step: string; title: string }) {
  return (
    <article className="flex flex-col rounded-2xl border-2 border-red-500 bg-white overflow-hidden shadow-xl hover:-translate-y-1 transition-all duration-300">
      <div className="p-7 text-center flex-1 flex flex-col items-center">
        <Icon className="h-10 w-10 text-red-400 mb-5" strokeWidth={1.5} />

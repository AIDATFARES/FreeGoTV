    ...
    <div className="my-10 space-y-4">
      {faqs.map((faq, index) => {
        ...
        return (
          <div
            key={index}
            className="rounded-xl border border-black/10 bg-white overflow-hidden transition-all duration-300 hover:border-red-500/40 shadow-lg"
          >
            <button
            ...
            >
              ...
              <ChevronDown
                className={`w-5 h-5 text-stone-600 transition-transform duration-300 shrink-0 ${

...
export default function HeroSection() {
  return (
    <section className="relative pt-24 md:pt-32 pb-16 md:pb-20 flex items-center justify-center bg-[#2F3136] overflow-hidden text-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-[#2F3136]/60" />
      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-6 flex flex-col items-center gap-6">
        ...
        {/* Top Tag */}
        <div className="inline-flex items-center border border-[#FF6B00] rounded-full px-4 py-1.5 backdrop-blur-sm bg-[#2F3136]/30">
        ...
        {/* Headline */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[80px] font-black tracking-tight leading-[1] text-[#2F3136] uppercase drop-shadow-2xl mt-4">
          BEST <span className="text-[#FF6B00]">IPTV</span> STREAMING –<br />
          FreeGoTV
        </h1>

        {/* Subtitle */}
        <p className="text-lg sm:text-xl text-[#2F3136]/90 font-medium max-w-2xl mt-2 drop-shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-5 mt-8 justify-center w-full sm:w-auto">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="py-4 px-8 text-sm sm:text-base font-bold text-[#2F3136] bg-[#FF6B00] hover:bg-[#E66000] transition-all duration-300 flex items-center justify-center tracking-wider hover:scale-105"
          >
        ...
        {/* Bottom Icons */}
        <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12 text-[#2F3136]/90 mt-4">
